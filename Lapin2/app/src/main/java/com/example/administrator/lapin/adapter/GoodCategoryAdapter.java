...
public class GoodCategoryAdapter extends BaseAdapter{
    private List<GoodCategoryBean.ContentBean>datas;
    private Context context;

    public GoodCategoryAdapter(List<GoodCategoryBean.ContentBean> datas, Context context) {
        this.datas = datas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(context).load("http://img.lapin365.com/productpictures"+datas.get(position).getLogo()).placeholder(R.mipmap.ic_launcher).into(viewHolder.iv);
        return convertView;
    }
    class ViewHolder{
        TextView txt;
